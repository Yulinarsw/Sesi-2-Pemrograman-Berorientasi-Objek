...
public class SimulasiMotorSonic {
    ...
    public static void main(String[] args) {
        SimulasiMotorSonic beatyuli = new SimulasiMotorSonic();

        beatyuli.dinyalakan();
        beatyuli.tambah_porseneling();
        beatyuli.tambah_porseneling();
        beatyuli.tambah_kecepatan(20);
        beatyuli.kurangi_kecepatan(5);
        beatyuli.kurangi_porseneling();
        beatyuli.tambah_kecepatan(10);
        beatyuli.tambah_kecepatan(10);
        beatyuli.tambah_porseneling();
        beatyuli.tambah_porseneling();
        beatyuli.tambah_porseneling();
